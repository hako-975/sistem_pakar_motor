<?php 
    ...
    $penilaian = mysqli_query($conn, "SELECT * FROM penilaian INNER JOIN kriteria ON penilaian.id_kriteria = kriteria.id_kriteria INNER JOIN jurusan ON penilaian.id_jurusan = jurusan.id_jurusan WHERE penilaian.id_hasil = '$id_hasil' GROUP BY penilaian.id_jurusan ORDER BY jurusan.nama_jurusan ASC");
    ...
    foreach ($kriteria as $dk) {
        ...
        foreach ($penilaian as $dp) {
            $id_jurusan_dp = $dp['id_jurusan'];
            $nilai = mysqli_fetch_assoc(mysqli_query($conn, "SELECT nilai FROM penilaian WHERE id_kriteria = '$id_kriteria_dk' AND id_jurusan = '$id_jurusan_dp' AND id_hasil = '$id_hasil'"));
    ...
    foreach ($penilaian as $dp) {
        $id_jurusan_dp = $dp['id_jurusan'];
        $row_normalisasi = ['id_jurusan' => $dp['id_jurusan'], 'nama_jurusan' => $dp['nama_jurusan']];
...
<html lang="en">
<head>
    <title>Hasil SPK Jurusan - <?= $data_hasil['nama_siswa']; ?></title>
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Hasil SPK Jurusan - <?= $data_hasil['nama_siswa']; ?></h3>
                        </div>
                        <div class="col-sm-6">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <?php 
                                                    mysqli_query($conn, "UPDATE hasil_topsis SET id_jurusan = '$id_jurusan', preferensi_tertinggi = '$highest' WHERE id_hasil = '$id_hasil'");
                                                 ?>
                                            </tbody>
                                        </table>
                                    </div>
