<?php 
    ...
    $hasil = mysqli_query($conn, "SELECT *, hasil_topsis.dibuat_pada as dibuat FROM hasil_topsis LEFT JOIN siswa ON hasil_topsis.id_siswa = siswa.id_siswa LEFT JOIN jurusan ON hasil_topsis.id_jurusan = jurusan.id_jurusan");
?>
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0"><i class="nav-icon fas fa-fw fa-calculator"></i> SPK Jurusan</h3>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive p-2">
                                <a href="tambah_spk.php" class="mb-3 btn btn-primary"><i class="fas fa-fw fa-plus"></i> Tambah SPK Jurusan</a>
